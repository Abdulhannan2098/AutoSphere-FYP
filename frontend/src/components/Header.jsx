              ...
              <>
                ...
                <div className="flex items-center space-x-4 pl-6 border-l border-surface-light">
                  <div className="flex items-center space-x-3">
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary-800 to-primary-700 flex items-center justify-center shadow-neon-red">
                  ...
                  <button
                    ...
                    className="text-sm font-medium text-text-tertiary hover:text-primary-500 transition-colors duration-200 flex items-center space-x-1.5 group"
                  >
              ...
              <>
                ...
                <div className="px-4 py-2">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-800 to-primary-700 flex items-center justify-center">
                      <span className="text-white font-bold text-sm">{user.name.charAt(0).toUpperCase()}</span>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-text-primary">{user.name}</p>
                      <p className={`text-xs px-2 py-0.5 rounded-full ${getRoleBadgeColor()} inline-block`}>
                        {user.role}
                      </p>
                    </div>
                  </div>
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-text-secondary hover:text-primary-500 hover:bg-surface-light rounded-lg transition-all"
                >
                  Logout
                </button>
              </>
