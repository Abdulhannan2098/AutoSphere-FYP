                    ...
                    <div className="flex items-center gap-3 px-4 py-2 bg-primary-500/10 border border-primary-500/30 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-text-secondary">
                          {orderGroup.length} orders from {orderGroup.length} vendors • Grand Total: ${orderGroup[0].grandTotal?.toFixed(2) || orderGroup.reduce((sum, o) => sum + o.totalAmount, 0).toFixed(2)}
                        </p>
                      </div>
                    </div>
                  )}
                            ...
                            {item.product?.images?.[0] ? (
                              <img
                                ...
                                onError={(e) => {
                                  ...
                                  e.target.src = 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=100&h=100&fit=crop';
                                }}
                              />
                            ) : (
