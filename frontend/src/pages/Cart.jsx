                ...
                <div key={vendorGroup.vendorId} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pb-3 border-b border-primary-500/30">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-display text-lg font-bold text-primary-500">${vendorGroup.subtotal.toFixed(2)}</p>
                    </div>
                  </div>
                    ...
                    {vendorGroup.items.map((item) => (
                      <div key={item.product._id} className="card">
                        <div className="flex gap-6">
                          {/* Product Image */}
                          <div className="w-32 h-32 bg-surface-light rounded-lg flex items-center justify-center flex-shrink-0">
